        ...
        <div className="row align-items-center">
          <div className="col-xl-5 col-lg-5">
            <div className="jm-promote-section-title-wrapper mtm-uptomd10 text-center text-lg-start pr-60 mb-40">
              ...
              <Link to="/jobPage" className="jm-theme-btn promote-btn mt-40">
                Browse Job
              </Link>
            </div>
          </div>
          <div className="col-xl-7 col-lg-7">
            ...
            >
              <Nav.Item>
                <Nav.Link
                  eventKey="nav-promote"
                  className={`jm-promote-tab-btn ${
                    activeTab === "nav-promote" ? "active" : ""
                  }`}
                >
                  Step One
                </Nav.Link>
              ...
              <Nav.Item>
                <Nav.Link
                  eventKey="nav-promote-1"
                  className={`jm-promote-tab-btn ${
                    activeTab === "nav-promote-1" ? "active" : ""
                  }`}
                >
                  Step Two
                </Nav.Link>
              ...
              <Nav.Item>
                <Nav.Link
                  eventKey="nav-promote-2"
                  className={`jm-promote-tab-btn ${
                    activeTab === "nav-promote-2" ? "active" : ""
                  }`}
                >
                  Step Three
                </Nav.Link>
            ...
            <Tab.Content className="mb-40" id="nav-tabContent-promote">
              <Tab.Pane
                ...
                className={`tab-pane fade ${
                  activeTab === "nav-promote" ? "show active" : ""
                }`}
              >
                <div className="jm-promote-item-single">
                  ...
                  <div className="jm-promote-item-inner">
                    <span className="jm-promote-item-icon">
                      <img
                        src="static/assets/img/services/step-1.png"
                        alt="img"
                      />
                    </span>
                    <div className="jm-promote-item-inner-content">
                      <h4 className="jm-promote-item-title">
                        Set up your Profile All
                      </h4>
                      <p className="jm-promote-item-desc">
              ...
              <Tab.Pane
                eventKey="nav-promote-1"
                className={`tab-pane fade ${
                  activeTab === "nav-promote-1" ? "show active" : ""
                }`}
              >
                <div className="jm-promote-item-single">
                  ...
                  <div className="jm-promote-item-inner">
                    <span className="jm-promote-item-icon">
                      <img
                        src="static/assets/img/services/step-2.png"
                        alt="img"
                      />
                    </span>
                    <div className="jm-promote-item-inner-content">
                      ...
                      <p className="jm-promote-item-desc">
                        Techcareer gives you more than 500 pre-made CV samples
                        for candidates to personalize their CVs.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <Tab.Pane
                eventKey="nav-promote-2"
                className={`tab-pane fade ${
                  activeTab === "nav-promote-2" ? "show active" : ""
                }`}
              >
                <div className="jm-promote-item-single">
                  ...
                  <div className="jm-promote-item-inner">
                    <span className="jm-promote-item-icon">
                      <img
                        src="static/assets/img/services/step-3.png"
                        alt="img"
                      />
                    </span>
                    <div className="jm-promote-item-inner-content">
                      ...
                      <p className="jm-promote-item-desc">
                        When owning a CV, don't hesitate to submit your CV to
                        easily apply for a job from Tech companies.
                      </p>
                    </div>
                  </div>
                </div>
