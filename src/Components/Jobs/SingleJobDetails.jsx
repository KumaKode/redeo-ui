          ...
          <div className="col-xl-8 col-lg-8">
            <div className="jm-job-content-wrapp">
              <img
                ...
                src="static/assets/img/blog/5.jpg"
                alt="img"
              />
                ...
                <div className="jm-job-content-title-text-wrapp">
                  <div className="jm-job-content-title-text">
                    <div className="jm-job-content-title-img">
                      <img src="static/assets/img/job/meta.png" alt="img" />
                    </div>
                    <div className="jm-job-content-title-bottom">
                      ...
                      <span className="jm-job-content-title-meta">
                        <i className="fa-thin fa-user"></i> 11 Vacancies
                      </span>
              ...
              <div className="jm-related-jobs-inner mb-40">
                  ...
                  <div className="jm-latest-job-layout-3-wrapper">
                    ...
                    <div className="jm-latest-job-layout-3-info">
                      <h4 className="jm-latest-job-layout-3-info-title">
                        <Link to="/jobDetailsPage">Software Solution Ltd</Link>
                      </h4>
                ...
                <div className="jm-latest-job-layout-3">
                  <div className="jm-latest-job-layout-3-wrapper">
                    ...
                    <div className="jm-latest-job-layout-3-info">
                      <h4 className="jm-latest-job-layout-3-info-title">
                        <Link to="/jobDetailsPage">IT Technology Company</Link>
                      </h4>
                      <div className="jm-latest-job-layout-3-info-meta">
                        <span>
                          <i className="fa-thin fa-tags"></i>WordPress, Java
                ...
                <div className="jm-latest-job-layout-3">
                  <div className="jm-latest-job-layout-3-wrapper">
                    ...
                    <div className="jm-latest-job-layout-3-info">
                      <h4 className="jm-latest-job-layout-3-info-title">
                        <Link to="/jobDetailsPage">Shoe Industry Limited</Link>
                      </h4>
                      <div className="jm-latest-job-layout-3-info-meta">
                        <span>
                          <i className="fa-thin fa-tags"></i>WordPress, Java
