          ...
          <div className="col-lg-4 order-1 order-lg-0">
            <div className="jm-candidate-author-wrapper mr-25 mb-40">
              <div className="jm-candidate-avater-portion jm-company-logo">
                <img src="static/assets/img/logo/company-logo.png" alt="img" />
              ...
              <div className="jm-candidate-profile-overview-portion">
                ...
                <ul className="jm-job-sidebar-review-list mb-15">
                  <li>
                    ...
                    <span className="jm-job-review-label">Owner : </span>{" "}
                    <span className="job-review-value">Khorshed Islam</span>
                  </li>
                  <li>
                    <i className="fa-light fa-transgender"></i>{" "}
                    <span className="jm-job-review-label">Gender : </span>{" "}
                    <span className="job-review-value">Male</span>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <span className="job-review-value">New York, USA</span>
                  </li>
                  <li>
                    <i className="fa-thin fa-star-sharp-half-stroke"></i>{" "}
                    <span className="jm-job-review-label">Estabished : </span>{" "}
                    <span className="job-review-value">25 Oct, 2015</span>
                  </li>
                </ul>
                    ...
                    <div className="jm-latest-job-layout-3">
                      <div className="jm-latest-job-layout-3-wrapper">
                        <div className="jm-latest-job-layout-3-img">
                          <img
                            src="static/assets/img/job/apple.png"
                            alt="apple"
                          />
                        </div>
                        <div className="jm-latest-job-layout-3-info">
                          ...
                          <div className="jm-latest-job-layout-3-info-meta">
                            ...
                            <span>
                              <i className="fa-thin fa-money-bill-1"></i>$35000
                              - $40000
                            </span>
                            <span>
                  ...
                  <div className="col-xl-12">
                    <div className="jm-latest-job-layout-3">
                      <div className="jm-latest-job-layout-3-wrapper">
                        <div className="jm-latest-job-layout-3-img">
                          <img
                            src="static/assets/img/job/volkswagen.png"
                            alt="apple"
                          />
                        </div>
                        <div className="jm-latest-job-layout-3-info">
                          ...
                          <div className="jm-latest-job-layout-3-info-meta">
                            ...
                            <span>
                              <i className="fa-thin fa-money-bill-1"></i>$5000 -
                              $10000
                            </span>
                            <span>
                  ...
                  <div className="col-xl-12">
                    <div className="jm-latest-job-layout-3">
                      <div className="jm-latest-job-layout-3-wrapper">
                        <div className="jm-latest-job-layout-3-img">
                          <img
                            src="static/assets/img/job/google.png"
                            alt="apple"
                          />
                        </div>
                        <div className="jm-latest-job-layout-3-info">
                          ...
                          <div className="jm-latest-job-layout-3-info-meta">
                            ...
                            <span>
                              <i className="fa-thin fa-money-bill-1"></i>$10000
                              - $500000
                            </span>
                            <span>
                              <i className="fa-thin fa-clock"></i>Part Time
                  ...
                  <div className="col-xl-12">
                    <div className="jm-latest-job-layout-3">
                      <div className="jm-latest-job-layout-3-wrapper">
                        <div className="jm-latest-job-layout-3-img">
                          <img
                            src="static/assets/img/job/meta.png"
                            alt="apple"
                          />
                        </div>
                        <div className="jm-latest-job-layout-3-info">
                  ...
                  <div className="col-xl-12">
                    <div className="jm-latest-job-layout-3">
                      <div className="jm-latest-job-layout-3-wrapper">
                        <div className="jm-latest-job-layout-3-img">
                          <img
                            src="static/assets/img/job/nike.png"
                            alt="apple"
                          />
                        </div>
                        <div className="jm-latest-job-layout-3-info">
                          ...
                          <div className="jm-latest-job-layout-3-info-meta">
                            <span>
                              <i className="fa-thin fa-tags"></i>Accessory,
                              Human
                            </span>
                            <span>
                              <i className="fa-thin fa-location-dot"></i>
                  ...
                  <div className="col-xl-12">
                    <div className="jm-latest-job-layout-3">
                      <div className="jm-latest-job-layout-3-wrapper">
                        <div className="jm-latest-job-layout-3-img">
                          <img
                            src="static/assets/img/job/starbuck.png"
                            alt="apple"
                          />
                        </div>
                        <div className="jm-latest-job-layout-3-info">
                          ...
                          <div className="jm-latest-job-layout-3-info-meta">
                            <span>
                              <i className="fa-thin fa-tags"></i>Designer,
                              Manager
                            </span>
                            <span>
                              <i className="fa-thin fa-location-dot"></i>
