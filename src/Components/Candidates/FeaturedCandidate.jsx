...
const FeaturedCandidate = () => {
  const team = [
    {
      name: "Dwayne Johnson",
      imgSrc: "static/assets/img/team/8.jpg",
      position: "Web Developer (6 Yrs Exp)",
    },
    {
      name: "Jon William",
      imgSrc: "static/assets/img/team/5.jpg",
      position: "Web Developer (6 Yrs Exp)",
    },
    {
      name: "Jennifer Blount",
      imgSrc: "static/assets/img/team/10.jpg",
      position: "UX/UI Designer (6 Yrs Exp)",
    },
    {
      name: "Chris Henry",
      imgSrc: "static/assets/img/team/11.jpg",
      position: "Marketing Expert (8 Yrs Exp)",
    },
    {
      name: "Alexander",
      imgSrc: "static/assets/img/team/9.jpg",
