          ...
          <div className="col-xl-4 col-lg-4 col-md-6">
            <div className="jm-blog-item mb-30">
              ...
              <div className="jm-blog-item-content">
                ...
                <p>
                  We are privileged to work with hund of future-thinking
                  businesses to Of this including many
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-xl-4 col-lg-4 col-md-6">
            <div className="jm-blog-item mb-30">
              <div className="jm-blog-item-img w_img">
                <Link to="/blogDetailsPage">
                  <img
                    src="static/assets/img/blog/4.jpg"
                    alt="Image Not Found"
                  />
                </Link>
                <div className="jm-blog-date">
              ...
              <div className="jm-blog-item-content">
                <h4 className="jm-blog-title">
                  <Link to="/blogDetailsPage">
                    you gain skills you get more opportunity for job
                  </Link>
                </h4>
                <p>
                  We are privileged to work with hund of future-thinking
          ...
          <div className="col-xl-4 col-lg-4 col-md-6">
            <div className="jm-blog-item mb-30">
              <div className="jm-blog-item-img w_img">
                <Link to="/blogDetailsPage">
                  <img
                    src="static/assets/img/blog/6.jpg"
                    alt="Image Not Found"
                  />
                </Link>
                <div className="jm-blog-date">
