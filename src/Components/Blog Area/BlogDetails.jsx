            ...
            <div className="jm-blog-details-wrap">
              ...
              <div className="jm-blog-details-content">
                <div className="jm-blog-details-meta mb-15">
                  <Link to="#">
                    <i className="fa-thin fa-user"></i>Jenifer
                  </Link>
                  <Link to="#">
                    <i className="fa-thin fa-calendar"></i>Dec-03-2018
                  </Link>
                </div>
                <p className="text mb-15">
                  It is a long established fact that a reader will be distracted
                  by the readable content of a page is when looking at its
                  layout. The point of using Lorem Ipsum is that it has a
                  more-or-less normal distribution of letters, as opposed to
                  using ique maiestatis sum quod sum ut alienum nec et to summo
                  possim persequeris vix mea. Adhuc quodsi qui, sit no tale
                  essent electramei sum sums rodesset in pro, quo scripta
                  feugait vidisse. Lorem ipsum dolor sit amet, eu duo ferri
                  labor dicat Mea ex modo reque senserit, et sed hinc dolor,
                  scaevola sum salutandi expetendis vix ne his quod mundi
                  consequat sum. There are not many of passages of lorem
                </p>
              ...
              <div className="jm-blog-details-quote mb-40 bg-default">
                ...
                <p>
                  ...
                  There many variations of passages of Lorem Ipsum Fastsby
                  injected , by injected humour, or randomise.
                </p>
                <h4 className="title">
                  Roden Boras <span> / Founder</span>
                </h4>
              </div>
              ...
              <div className="jm-blog-details-comment mb-45">
                ...
                <div className="jm-blog-details-comment-box">
                  <div className="jm-blog-details-box-img">
                    <img src="static/assets/img/blog/admin-3.jpg" alt="" />
                  </div>
                ...
                <div className="jm-blog-details-comment-box ml-80">
                  <div className="jm-blog-details-box-img">
                    <img src="static/assets/img/blog/admin-2.jpg" alt="" />
                  </div>
                  <div className="jm-blog-details-box-info">
                ...
                <div className="jm-blog-details-comment-box">
                  <div className="jm-blog-details-box-img">
                    <img src="static/assets/img/blog/admin-1.jpg" alt="" />
                  </div>
                  <div className="jm-blog-details-box-info">
                  ...
                  <div className="row">
                    ...
                    <div className="col-12">
                      <textarea
                        ...
                        cols="30"
                        rows="10"
                        placeholder="Wright your comment here …"
                      ></textarea>
                    </div>
                    <div className="col-12">
            ...
            <div className="jm-blog-sidebar ml-40">
              <div className="jm-blog-sidebar-widget mb-35">
                ...
                <form action="#" className="m-blog-sidebar-form">
                  <input
                    ...
                    placeholder="Search"
                  />
                  <button type="submit" className="blog-sidebar-btn">
              ...
              <div className="jm-blog-sidebar-widget mb-35">
                ...
                <div className="jm-blog-sidebar-post mb-20">
                  ...
                  <div className="jm-blog-sidebar-post-content">
                    <h6 className="title">
                      <Link to="/blogDetailsPage">How to Work Instagram</Link>
                    </h6>
                ...
                <div className="jm-blog-sidebar-post">
                  ...
                  <div className="jm-blog-sidebar-post-content">
                    <h6 className="title">
                      <Link to="/blogDetailsPage">Create a Wordpress Site</Link>
                    </h6>
                    <span>25 May, 2022</span>
                  </div>
                </div>
              ...
              <div className="jm-blog-sidebar-widget mb-35">
                <div className="jm-blog-sidebar-inner blog-category">
                  <h3 className="jm-blog-sidebar-widget-title">
                    by Categories
                  </h3>
                </div>
                <div className="jm-blog-sidebar-category">
                  <ul>
                    <li>
                      <Link to="#">
                        <i className="fa-thin fa-angle-right"></i>Health Care
                      </Link>
                    </li>
                    <li>
                      <Link to="#">
                        <i className="fa-thin fa-angle-right"></i>Management
                      </Link>
                    </li>
                    <li>
                      <Link to="#">
                        <i className="fa-thin fa-angle-right"></i>Marketing
                      </Link>
                    </li>
                    <li>
                      <Link to="#">
                        <i className="fa-thin fa-angle-right"></i>UX/UI
                        Developer
                      </Link>
                    </li>
                    <li>
                      <Link to="#">
                        <i className="fa-thin fa-angle-right"></i>WEB Developer
                      </Link>
                    </li>
                    <li>
                      <Link to="#">
                        <i className="fa-thin fa-angle-right"></i>Graphic
                        designer
                      </Link>
                    </li>
                  </ul>
