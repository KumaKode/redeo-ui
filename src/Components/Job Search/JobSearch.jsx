              ...
              <div className="jm-team-item-2 mb-30">
                <div className="jm-team-item-body-2">
                  <div className="jm-team-item-img-2 w_img">
                    <img
                      src="static/assets/img/team/8.jpg"
                      alt="Image Not Found"
                    />
                  </div>
                  <div className="jm-team-item-content-2">
                    <h4 className="title">
                      <Link to="/candidateDetailsPage">Dwayne Johnson</Link>
                    </h4>
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="jm-team-item-2 mb-30">
                <div className="jm-team-item-body-2">
                  <div className="jm-team-item-img-2 w_img">
                    <img
                      src="static/assets/img/team/5.jpg"
                      alt="Image Not Found"
                    />
                  </div>
                  <div className="jm-team-item-content-2">
                    <h4 className="title">
                      <Link to="/candidateDetailsPage">Jon William</Link>
                    </h4>
                    <span>Web Developer (6 Yrs Exp)</span>
                    <div className="jm-team-item-social-2">
                      <Link to="#">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="jm-team-item-2 mb-30">
                <div className="jm-team-item-body-2">
                  <div className="jm-team-item-img-2 w_img">
                    <img
                      src="static/assets/img/team/10.jpg"
                      alt="Image Not Found"
                    />
                  </div>
                  <div className="jm-team-item-content-2">
                    <h4 className="title">
                      <Link to="/candidateDetailsPage">Jennifer Blount</Link>
                    </h4>
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="jm-team-item-2 mb-30">
                <div className="jm-team-item-body-2">
                  <div className="jm-team-item-img-2 w_img">
                    <img
                      src="static/assets/img/team/11.jpg"
                      alt="Image Not Found"
                    />
                  </div>
                  <div className="jm-team-item-content-2">
                    <h4 className="title">
                      <Link to="/candidateDetailsPage">christopher henry</Link>
                    </h4>
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="jm-team-item-2 mb-30">
                <div className="jm-team-item-body-2">
                  <div className="jm-team-item-img-2 w_img">
                    <img
                      src="static/assets/img/team/9.jpg"
                      alt="Image Not Found"
                    />
                  </div>
                  <div className="jm-team-item-content-2">
                    <h4 className="title">
                      <Link to="/candidateDetailsPage">Alexander Jeny</Link>
                    </h4>
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="jm-team-item-2 mb-30">
                <div className="jm-team-item-body-2">
                  ...
                  <div className="jm-team-item-content-2">
                    <h4 className="title">
                      <Link to="/candidateDetailsPage">Jhon Smith</Link>
                    </h4>
                    <span>PHP Developer (5 Yrs Exp)</span>
                    <div className="jm-team-item-social-2">
                      <Link to="#">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="jm-team-item-2 mb-30">
                <div className="jm-team-item-body-2">
                  ...
                  <div className="jm-team-item-content-2">
                    <h4 className="title">
                      <Link to="/candidateDetailsPage">Angenlina</Link>
                    </h4>
                    <span>PHP Developer (5 Yrs Exp)</span>
                    <div className="jm-team-item-social-2">
                      <Link to="#">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="jm-team-item-2 mb-30">
                <div className="jm-team-item-body-2">
                  ...
                  <div className="jm-team-item-content-2">
                    <h4 className="title">
                      <Link to="/candidateDetailsPage">Alexander</Link>
                    </h4>
                    <span>PHP Developer (5 Yrs Exp)</span>
                    <div className="jm-team-item-social-2">
                      <Link to="#">
