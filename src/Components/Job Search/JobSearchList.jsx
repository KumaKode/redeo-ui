                ...
                <div className="jm-latest-job-layout-3-wrapper">
                  <div className="jm-latest-job-layout-3-img">
                    <Link to="/candidateDetailsPage">
                      <img src="static/assets/img/team/9.jpg" alt="img" />
                    </Link>
                  </div>
                  <div className="jm-latest-job-layout-3-info">
                    ...
                    <h4 className="jm-latest-job-layout-3-info-title">
                      <Link to="/candidateDetailsPage">Jennifa Lottery</Link>{" "}
                    ...
                    <div className="jm-latest-job-layout-3-info-meta">
                      <span>
                        <i className="fa-thin fa-tags"></i>HTML, CSS3
                      </span>
                      <span>
                        <i className="fa-thin fa-location-dot"></i>Cupertino,
                        USA
                      </span>
                      <span>
                        <i className="fa-thin fa-money-bill-1"></i>$5000 - $1000
                      </span>
                      <span>
            ...
            <div className="col-xl-12">
              <div className="jm-latest-job-layout-3 jm-candidate-layout-list">
                <div className="jm-latest-job-layout-3-wrapper">
                  <div className="jm-latest-job-layout-3-img">
                    <Link to="/candidateDetailsPage">
                      <img src="static/assets/img/team/10.jpg" alt="img" />
                    </Link>
                  </div>
                  <div className="jm-latest-job-layout-3-info">
                    <span className="jm-candidate-list-designation">
                    ...
                    <h4 className="jm-latest-job-layout-3-info-title">
                      <Link to="/candidateDetailsPage">Angelina Jelly</Link>{" "}
                      <span className="jm-candidate-rating">
                        <i className="fa-thin fa-star"></i> 4.9
                      </span>
                    </h4>
                    <div className="jm-latest-job-layout-3-info-meta">
                      <span>
                        <i className="fa-thin fa-tags"></i>WordPress, PHP
                      </span>
                      <span>
                        <i className="fa-thin fa-location-dot"></i>Cupertino,
                        USA
                      ...
                      <span>
                        <i className="fa-thin fa-money-bill-1"></i>$15000 -
                        $5000
                      </span>
                      <span>
                        <i className="fa-thin fa-clock"></i>Full Time
            ...
            <div className="col-xl-12">
              <div className="jm-latest-job-layout-3 jm-candidate-layout-list">
                <div className="jm-latest-job-layout-3-wrapper">
                  <div className="jm-latest-job-layout-3-img">
                    <Link to="/candidateDetailsPage">
                      <img src="static/assets/img/team/11.jpg" alt="img" />
                    </Link>
                  </div>
                  <div className="jm-latest-job-layout-3-info">
                    <span className="jm-candidate-list-designation">
                    ...
                    <h4 className="jm-latest-job-layout-3-info-title">
                      <Link to="/candidateDetailsPage">Abraham Linkon</Link>{" "}
                      <span className="jm-candidate-rating">
                        <i className="fa-thin fa-star"></i> 4.9
                      </span>
                    </h4>
            ...
            <div className="col-xl-12">
              <div className="jm-latest-job-layout-3 jm-candidate-layout-list">
                <div className="jm-latest-job-layout-3-wrapper">
                  <div className="jm-latest-job-layout-3-img">
                    <Link to="/candidateDetailsPage">
                      <img src="static/assets/img/team/8.jpg" alt="img" />
                    </Link>
                  </div>
                  <div className="jm-latest-job-layout-3-info">
                    <span className="jm-candidate-list-designation">
                    ...
                    <h4 className="jm-latest-job-layout-3-info-title">
                      <Link to="/candidateDetailsPage">Mikel Smith</Link>{" "}
                      <span className="jm-candidate-rating">
                        <i className="fa-thin fa-star"></i> 4.9
                      </span>
                    </h4>
                    <div className="jm-latest-job-layout-3-info-meta">
                      <span>
                        <i className="fa-thin fa-tags"></i>PHP, CMS
                      </span>
                      <span>
                        <i className="fa-thin fa-location-dot"></i>Cupertino,
                        USA
            ...
            <div className="col-xl-12">
              <div className="jm-latest-job-layout-3 jm-candidate-layout-list">
                <div className="jm-latest-job-layout-3-wrapper">
                  <div className="jm-latest-job-layout-3-img">
                    <Link to="/candidateDetailsPage">
                      <img src="static/assets/img/team/7.jpg" alt="img" />
                    </Link>
                  </div>
                  <div className="jm-latest-job-layout-3-info">
                    <span className="jm-candidate-list-designation">
                    ...
                    <h4 className="jm-latest-job-layout-3-info-title">
                      <Link to="/candidateDetailsPage">Virat Kohly</Link>{" "}
                      <span className="jm-candidate-rating">
                        <i className="fa-thin fa-star"></i> 4.9
                      </span>
                    </h4>
            ...
            <div className="col-xl-12">
              <div className="jm-latest-job-layout-3 jm-candidate-layout-list">
                <div className="jm-latest-job-layout-3-wrapper">
                  <div className="jm-latest-job-layout-3-img">
                    <Link to="/candidateDetailsPage">
                      <img src="static/assets/img/team/6.jpg" alt="img" />
                    </Link>
                  </div>
                  <div className="jm-latest-job-layout-3-info">
                    <span className="jm-candidate-list-designation">
                    ...
                    <h4 className="jm-latest-job-layout-3-info-title">
                      <Link to="/candidateDetailsPage">Jennifar Loppez</Link>{" "}
                      <span className="jm-candidate-rating">
                        <i className="fa-thin fa-star"></i> 4.9
                      </span>
                    </h4>
                    <div className="jm-latest-job-layout-3-info-meta">
                      <span>
                        <i className="fa-thin fa-tags"></i>XD, Figma
                      </span>
                      <span>
                        <i className="fa-thin fa-location-dot"></i>Cupertino,
                        USA
            ...
            <div className="col-xl-12">
              <div className="jm-latest-job-layout-3 jm-candidate-layout-list">
                <div className="jm-latest-job-layout-3-wrapper">
                  <div className="jm-latest-job-layout-3-img">
                    <Link to="/candidateDetailsPage">
                      <img src="static/assets/img/team/5.jpg" alt="img" />
                    </Link>
                  </div>
                  <div className="jm-latest-job-layout-3-info">
                    <span className="jm-candidate-list-designation">
                    ...
                    <h4 className="jm-latest-job-layout-3-info-title">
                      <Link to="/candidateDetailsPage">Elon Mask</Link>{" "}
                      <span className="jm-candidate-rating">
                        <i className="fa-thin fa-star"></i> 4.9
                      </span>
                    </h4>
                    <div className="jm-latest-job-layout-3-info-meta">
                      <span>
                        <i className="fa-thin fa-tags"></i>Human, Management
                      </span>
                      <span>
                        <i className="fa-thin fa-location-dot"></i>Cupertino,
                        USA
